<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="manage-activity.aspx.cs" Inherits="admin_manage_activity" %>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-danger">
                ...
                <div class="card-header">
                    <h3 class="card-title">Manage Photo</h3>
                                ...
                                <asp:GridView ID="grdproducts" AutoGenerateColumns="false" ShowHeader="true" ShowFooter="False" class="table table-bordered table-striped gvv" runat="server" CellPadding="15" AllowPaging="True" OnPageIndexChanging="grdproducts_PageIndexChanging" PageSize="30" AllowSorting="True" PagerSettings-Position="Bottom" OnRowDataBound="grdproducts_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Name">
                                            <ItemTemplate>
                                                <asp:Label runat="server" Text='<%# Eval("activity_name") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        
                                        <asp:TemplateField HeaderText="Photo">
                                            <ItemTemplate>
                                                <img src='<%# Eval("url") %>' style="width:150px;height:auto;" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
