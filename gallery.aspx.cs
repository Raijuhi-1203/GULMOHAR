...
public partial class gallery : System.Web.UI.Page
{
    ...
    {
        rptbinddata.DataSource = mst.GetData("SELECT * FROM gallery order by id asc");
    ...
    protected void rptbinddata_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        if (e.CommandName.Equals("btndelete"))
        {
            ...
            SqlDataReader dr_delete_seller = mst.Delete_Operation("delete from gallery where id='" + lbldeletesellerid.Text + "'");
