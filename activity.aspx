<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="activity.aspx.cs" Inherits="activity" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container-fluid bg-breadcrumb">
        ...
        <div class="container text-center py-5" style="max-width: 900px;">
            <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">School Activity</h4>
        </div>
    </div>
    <!-- Header End -->
    <!-- Project Start -->
                ...
                <ItemTemplate>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded p-4" style="background-image: url(img/bg.png);">
                                <h5 class="fs-5 mb-3"><center><%# Eval("activity_name") %></center></h5>
...
<%--                    <div class="col-md-4">
                        ...
                        <div class="project-content bg-light rounded p-2">
                            <div class="project-content-inner">
                                <div class="project-icon mb-3"></div>
                                <h5 class="fs-5 mb-3"><center><%# Eval("activity_name") %></center></h5>
