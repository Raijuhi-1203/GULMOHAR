<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="manage-career.aspx.cs" Inherits="admin_manage_career" %>
                                ...
                                <asp:GridView ID="grdproducts" AutoGenerateColumns="false" ShowHeader="true" ShowFooter="False" class="table table-bordered table-striped gvv" runat="server" CellPadding="15" AllowPaging="True" OnPageIndexChanging="grdproducts_PageIndexChanging" PageSize="30" AllowSorting="True" PagerSettings-Position="Bottom" OnRowDataBound="grdproducts_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Mobile No.">
                                            <ItemTemplate>
                                                <asp:Label ID="txtmb" runat="server" Text='<%# Eval("mobileno") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        
                                        <asp:TemplateField HeaderText="Email">
                                            <ItemTemplate>
                                                <asp:Label ID="txte" runat="server" Text='<%# Eval("email") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        
                                        <asp:TemplateField HeaderText="Role">
                                            <ItemTemplate>
                                                <asp:Label ID="txts" runat="server" Text='<%# Eval("role") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        
                                        <asp:TemplateField HeaderText="Experience">
                                            <ItemTemplate>
                                                <asp:Label ID="txtm" runat="server" Text='<%# Eval("experience") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        
                                        <asp:TemplateField HeaderText="Details">
                                            <ItemTemplate>
                                                <asp:Label ID="txd" runat="server" Text='<%# Eval("details") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemTemplate>
                                               <a class="link-success" href="<%#  Eval("resume") %>"  title="Resume" target="_blank"><i class="fa fa-file"></i></a> | 
