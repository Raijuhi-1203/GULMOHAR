...
public partial class admin_manage_activity : System.Web.UI.Page
{
    ...
    {
        lblquery.Text = "SELECT * FROM activity order by id asc";
    ...
    {
        SqlDataReader deleteData = mst.Delete_Operation("delete from activity where id='" + lbldeleteRowId.Text + "'");
        deleteData.Close();
