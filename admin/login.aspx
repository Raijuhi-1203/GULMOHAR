...
<body class="hold-transition login-page" style="background:#01c2fb;">
<%--<body class="hold-transition login-page" style="background-image: url('https://prayas.digitalbull.in/admin/upload/back.jpg')">--%>
    
    <form id="form1" runat="server">
        <div class="login-box">
            <div class="login-logo" style="color:#000;font-family:Bahnschrift;">
                <%--<img src="assets/logo.png" style="width:200px;height:auto;background-color: #ffffff94;border-radius: 100px;padding:10px;" />--%>
                <b>Gulmuhar Green School</b>
            </div>
            ...
            <center>
                <p style="font-family:Bahnschrift;">©2024 All right reserved by Digital Bull</p>
            </center>
        </div>
    </form>
