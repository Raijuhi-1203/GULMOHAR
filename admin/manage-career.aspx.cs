...
public partial class admin_manage_career : System.Web.UI.Page
{
    ...
    {
        lblquery.Text = "SELECT * FROM career order by id asc";
    ...
    {
        SqlDataReader deleteData = mst.Delete_Operation("delete from career where id='" + lbldeleteRowId.Text + "'");
        deleteData.Close();
