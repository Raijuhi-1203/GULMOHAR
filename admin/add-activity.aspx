<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="add-activity.aspx.cs" Inherits="admin_add_activity" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Activity Name<span style="color: red">&nbsp;*</span> </label>
