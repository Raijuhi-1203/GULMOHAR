...
public partial class admin_manage_notice : System.Web.UI.Page
{
    ...
    {
        lblquery.Text = "SELECT * FROM notice order by id asc";
    ...
    {
        SqlDataReader deleteData = mst.Delete_Operation("delete from notice where id='" + lbldeleteRowId.Text + "'");
        deleteData.Close();
