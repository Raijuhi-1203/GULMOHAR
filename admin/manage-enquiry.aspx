<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="manage-enquiry.aspx.cs" Inherits="admin_manage_addication" %>
                                ...
                                <asp:GridView ID="grdproducts" AutoGenerateColumns="false" ShowHeader="true" ShowFooter="False" class="table table-bordered table-striped gvv" runat="server" CellPadding="15" AllowPaging="True" OnPageIndexChanging="grdproducts_PageIndexChanging" PageSize="30" AllowSorting="True" PagerSettings-Position="Bottom" OnRowDataBound="grdproducts_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Subject">
                                            <ItemTemplate>
                                                <asp:Label ID="txts" runat="server" Text='<%# Eval("subject") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        
                                        <asp:TemplateField HeaderText="Message">
                                            <ItemTemplate>
                                                <asp:Label ID="txtm" runat="server" Text='<%# Eval("message") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
